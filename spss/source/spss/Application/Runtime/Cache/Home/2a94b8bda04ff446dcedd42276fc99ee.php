...
//		导航购物车的左切换
 ...
 <link rel="stylesheet" href="/spss/source/spss/Public/css/home.css" />		
<!--banner-->
			...
			<div id="container">
				<div class="sections">
					...
					<?php foreach ($list as $k => $v): ?>
						<div class="section" id="section<?php echo ($k); ?>"><a href="/spss/source/spss/index.php/<?php echo ($v["url"]); ?>"><img src="<?= getimage($v['image']) ?>" alt="" /></a></div>
					<?php endforeach ?>
...
<div class="home-main" style="display:none">
	<div class="home-main-content">
		<div class="home-main-content1">
			<a href="<?php echo U('Furnish/index');?>" style="display: block;color: #000;">
				<p>舒适健康家居</p>
				<p class="home-main-content1-img1"></p>
			</a>
		</div>
		<div class="home-main-content2">
			<a href="<?php echo U('Material/floorList');?>" style="display: block;color: #000;">
				<p>舒适健康建材</p>
				<p class="home-main-content1-img2"></p>
			</a>	
		</div>
		<div class="home-main-content2">
			<a href="<?php echo U('Customer/index');?>" style="display: block;color: #000;">
			<p>舒适健康售后</p>
			<p class="home-main-content2-lianbao home-main-content1-img3"></p>
			</a>
		</div>
		<div class="home-main-content3">
			<a href="<?php echo U('Knowledge/index');?>" style="display: block;color: #000;">
			<p>家居知识了解</p>
			<p class="home-main-content1-img4"></p>
			</a>
		</div>
	</div>
</div>
<link rel="stylesheet" href="/spss/source/spss/Public/css/pageSwitch.min.css" />
<script src="/spss/source/spss/Public/js/pageSwitch.js"></script>
<script>
