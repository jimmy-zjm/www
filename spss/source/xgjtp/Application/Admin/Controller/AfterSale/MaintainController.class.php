...
class MaintainController extends AdminController{
	...
	public function index(){
		...
		//分页
		$count = M('xgj_user_problem p')->join("xgj_furnish_quote q on p.quote_id=q.quote_id")->join('xgj_furnish_order_info o on o.order_id=p.order_id')->count();
